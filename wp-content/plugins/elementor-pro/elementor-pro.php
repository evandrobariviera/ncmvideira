...
add_action( 'plugins_loaded', function() {
	...
	// Ultrapack: devolver $pre, nao false. Este e o ramo catch-all: ele responde por
	// TODA URL que os ifs acima nao trataram. Com "return false" ele descartava o
	// short-circuit de qualquer outro filtro pre_http_request registrado antes deste
	// (o hook e encadeado: o retorno de um vira o $pre do proximo), forcando a
	// requisicao real a sair. Isso anulava, entre outros, a interceptacao do
	// Wordfence Activator em todo site com os dois plugins. Devolvendo $pre o
	// comportamento fica inalterado quando ninguem interceptou ($pre ja e false).
	return $pre;
	}, 10, 3 );
} );
