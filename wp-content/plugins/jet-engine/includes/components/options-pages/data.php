...
if ( ! class_exists( 'Jet_Engine_Options_Data' ) ) {
	...
	class Jet_Engine_Options_Data extends Jet_Engine_Base_Data {
		...
		public function filter_item_for_register( $item ) {
			...
			$args           = jet_engine_safe_unserialize_array( $item['args'], 'options_pages_register_args' );
			$item['labels'] = jet_engine_safe_unserialize_array( $item['labels'], 'options_pages_register_labels' );
			$item['fields'] = jet_engine_safe_unserialize_array( $item['meta_fields'], 'options_pages_register_fields' );
		...
		public function filter_item_for_edit( $item ) {
			...
			$args   = jet_engine_safe_unserialize_array( $item['args'], 'options_pages_edit_args' );
			$labels = jet_engine_safe_unserialize_array( $item['labels'], 'options_pages_edit_labels' );
			$fields = array();
			...
			if ( ! empty( $item['meta_fields'] ) ) {
				...
				$fields = jet_engine_safe_unserialize_array( $item['meta_fields'], 'options_pages_edit_fields' );
